...
/*
    We’ve seen that we can use % (the remainder operator) to test whether a number is even
    ...
    should accept a single parameter (a positive, whole num- ber) and return a Boolean.
